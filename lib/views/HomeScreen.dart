                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              borderRadius: BorderRadius.all(Radius.circular(Dimension.safeBlockVertical * 2))
                            ),
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                          ...
                          itemBuilder: (context, index) {
                            return Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Image.asset(
                                      index == 0 ? "${Environments.imageAssets}IMG_3115.jpg": "${Environments.imageAssets}IMG_3116.jpg",
                                    ),
                                    Text(
                                      "Kelas 5 Menit",
                                      style: TextStyle(
                                    ...
                                    Text(
                                      index == 0 ?"Lemah tapi dominan" : "Fenomena barang inferior",
                                      style: TextStyle(
                                          fontSize: Dimension.safeBlockVertical * 2,
                                      ),
                                    )
                      ...
                      Image.asset(
                        "${Environments.imageAssets}IMG_3117.jpg"
                      ),
                      SizedBox(
                        height: Dimension.safeBlockVertical * 4.5,
                      ),
