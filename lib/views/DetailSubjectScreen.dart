                    ...
                    child: Stack(
                      children: [
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    ...
                                    style: TextStyle(
                                        fontSize:
                                            Dimension.safeBlockVertical * 2.5,
                                        color: Colors.white),
                                  ),
                                  SizedBox(
                                    width: Dimension.safeBlockVertical,
                        ...
                        Positioned(
                            ...
                            bottom: 0.0,
                            child: Image.asset(
                                "${Environments.imageAssets}mtk_1.png"))
                      ],
                    )),
                Container(
                            ...
                            Container(
                              ...
                              child: TabBar(
                                ...
                                indicator: new BubbleTabIndicator(
                                  indicatorHeight:
                                      Dimension.safeBlockVertical * 4.5,
                                ...
                                tabs: [
                                  Tab(
                                    ...
                                    style: TextStyle(
                                        fontSize:
                                            Dimension.safeBlockVertical * 1.5),
                                  )),
                                  Tab(
                                      child: Text(
                                    "Sudah dipelajari",
                                ...
                                children: [
                                  Column(
                                    children: [
                                      ...
                                      Divider(
                                        height:
                                            Dimension.safeBlockVertical * 0.15,
                                        color: Colors.grey,
                                        thickness:
                                            Dimension.safeBlockVertical * 0.15,
                                      ),
